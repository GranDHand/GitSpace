...
<c:url value="${pageContext.request.contextPath}" var ="path"></c:url>
 ...
 <div id="wrapper" >
        ...
        <nav class="navbar-default navbar-side" role="navigation" >
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="assApply"><i class="fa fa-circle-o"></i>修改</a>
                    </li>
                </ul>
        ...
        <div id="page-wrapper">
			...
			<div>
				<form action="toUpdatePerm" method="POST" id="mtp_style" >
				<!--    spring security默认开启CSRF防护，所以所有POST表单都必须包含csrf.token -->
   					<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
					社团名：<input type="text" name="ass_name" id="ass_name"><br>
					
					&nbsp;&nbsp;&nbsp;学号：<input type="text" name="stu_username"><br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <script src="${pageContext.request.contextPath}/public/assets/js/paging.js" type="text/javascript"></script>
</body>
</html>