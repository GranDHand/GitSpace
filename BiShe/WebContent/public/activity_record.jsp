        ...
        <div id="page-wrapper">
            ...
            <div class="panel-body">
                <table class="table table-bordered" style="margin-left:110px">
                   ...
                   <tbody>
                    <c:forEach items="${allRecord.list}" var="allR" varStatus="status">
                       <tr>
                        <td id="ass_name">${allR.ass_act_time }</td>
                        <td>${allR.ass_act_address }</td>
                        <td>${allR.ass_act_name}</td>
                       </tr>
                    </c:forEach>
                   </tbody>
                </table>
			...
			<div id="u_li">
                       <ul class="pagination">
 							<li style="display:none"><a href="javascript:;" class="allAss">${allRecord.totalPage}</a></li>
                            <li><a href="javascript:;" >总共有${allRecord.totalRecord}个信息</a></li>
                            ...
                            <li><a href="javascript:void(0);"id="page">当前页为：<span id ="cur_page">${allRecord.pageNum}/${allRecord.totalPage}</span></a></li><br><br>
                        </ul>
               </div>
        </div>
             <!--/.ROW-->
