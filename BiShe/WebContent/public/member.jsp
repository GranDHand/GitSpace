...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="panel-body" style="margin-left:130px">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                        <c:forEach items="${member.list}" var="member"  varStatus="status">
                        <tr>
                            <td>&nbsp;&nbsp;&nbsp;</td>
                            <td>${member.stu_name}</td>
                            <td>${member.stu_major}</td>
                            <td>${member.stu_class}</td>
                            <td>${member.stu_grade}</td>
                        </tr>
                        </c:forEach>
                        </tbody>
                    </table>
                ...
                <div id="u_li">
                       <ul class="pagination">
 							<li style="display:none"><a href="javascript:;" class="allAss">${member.totalPage}</a></li>
 							<li style="display:none"class="username">${stgl.username}</a></li>
                            <li><a href="javascript:;" >总共有${member.totalRecord}条信息</a></li>
                            ...
                            <li><a href="javascript:void(0);"id="page">当前页为：<span id ="cur_page">${member.pageNum}/${member.totalPage}</span></a></li><br>
                        </ul>
                    </div>
                <!-- /. ROW  -->
            </div>
    ...
    <script src="public/assets/js/findAllMember.js" type="text/javascript"></script>
